...
function roles_admin_showprivileges()
{
    ...
    // Security Check
    // Must have access levels: ReadPrivileges or
    // DeleteRole or DeleteGroupRoles
    // AddRole or AddGroupRole for view privs
    // don't throw exception, handle the response
    if (!xarSecurityCheck('ReadPrivilege',0)  &&  !xarSecurityCheck('AddRole',0,'Roles',$uid)
