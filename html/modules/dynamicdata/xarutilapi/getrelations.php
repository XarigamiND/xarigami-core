...
//    $hooklist = xarMod::getHookList($modinfo['name'],'item','display');
    $hooklist = array_merge(xarMod::getHookList($modinfo['name'],'item','display'),
                            xarMod::getHookList($modinfo['name'],'item','update'));
    $modlist = array();
