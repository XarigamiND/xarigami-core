...
class xarCurl
{
    ...
    // No proprietory (i.e. Xarigami-specific) error handling here - the caller
    ...
    *
    * This method extracted from other classes in Xarigami (see nusoap).
    *
    * @param    string $buffer
    * @return   string
    * @access   public
