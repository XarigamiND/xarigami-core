...
class Dynamic_CountryList_Property extends Dynamic_Select_Property
{
   ...
   function getOptions()
   {
        ...
        if (empty($coptions)) {
            //jojo - note if we use entities here in xarML we cannot prep for display in template
            ...
            // allow validation options to appear at top of the list
            uasort($coptions, array($this,'countrysort'));
        }
        return $coptions;
