<?php
//Updating DD Image property validations to new format
...
function fix_140_16()
{
    ...
    $data['success'] = true;
    $data['task'] = xarML("Updating DD Image validations");
    ...
    try {
        ...
        //get all properties defined with this proptype/format of 12 (image)
