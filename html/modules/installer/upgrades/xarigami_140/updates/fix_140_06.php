<?php
//Updating DD URL Icon validations to new format
...
function fix_140_06()
{
    ...
    $data['success'] = true;
    $data['task'] = xarML("Updating DD URL Icon validations");
   ...
   try {
        ...
        //get all properties defined with this proptype/format of 27 (URL icon)
        ...
        //we have properties to possibly update validations
           ...
           if (!$serialized) {
                ...
                //let's fix it
                if (isset($propvalidation)) $defaultval['xv_icon_url']   = $propvalidation;
