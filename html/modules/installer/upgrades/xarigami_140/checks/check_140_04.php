<?php
// Check format of Email DD validations
function check_140_04()
{
   // Define the task and result
    $data['success'] = true;
    $data['task'] = xarML("Checking format of Email DD validations");
    ...
    try {
        ...
        //get all properties defined with this proptype format of 3, 4 or 5 (small, medium, large)
