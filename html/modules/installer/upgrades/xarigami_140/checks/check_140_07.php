<?php
// Check format of Float Box validations
function check_140_07()
{
   // Define the task and result
    $data['success'] = true;
    $data['task'] = xarML("Checking format of Float Box and Local Currency DD validations");
    ...
    try {
        ...
        //get all properties defined with this proptype format of 17
         $query = "SELECT xar_prop_id, xar_prop_name, xar_prop_source, xar_prop_validation
                    FROM $dynamicprops
                   WHERE xar_prop_type = 17 or xar_prop_type = 48";
