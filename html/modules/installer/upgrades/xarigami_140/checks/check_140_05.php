<?php
// Check format of URL and URL Title DD validations
function check_140_05()
{
   // Define the task and result
    $data['success'] = true;
    $data['task'] = xarML("Checking format of URL and URL Title DD validations");
    ...
    try {
        ...
        //get all properties defined with this proptype format of 11 or 41
