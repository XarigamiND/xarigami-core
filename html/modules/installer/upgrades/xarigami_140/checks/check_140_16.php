<?php
// Check label for image DD property validation
function check_140_16()
{
   // Define the task and result
    $data['success'] = true;
    $data['task'] = xarML("Checking format of Image DD validations");
    ...
    try {
        ...
        //get all properties defined with this proptype format of 12
         $query = "SELECT xar_prop_id, xar_prop_name, xar_prop_source, xar_prop_validation
                    FROM $dynamicprops
                   WHERE xar_prop_type = 12";
