<?php
// Check format of image list
function check_140_11()
{
   // Define the task and result
    $data['success'] = true;
    $data['task'] = xarML("Checking image and file list DD validations");
    ...
    try {
        ...
        //get all properties defined with this proptype format of 35
