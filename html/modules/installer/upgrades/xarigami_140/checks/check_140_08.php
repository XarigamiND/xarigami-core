<?php
// Check format of Checkbox validations
function check_140_08()
{
   // Define the task and result
    $data['success'] = true;
    $data['task'] = xarML("Checking format of Checkbox DD validations");
    ...
    try {
        ...
        //get all properties defined with this proptype format of 14
