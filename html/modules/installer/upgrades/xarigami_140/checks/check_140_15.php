...
function check_140_15()
{
   // Define the task and result
    $data['success'] = true;
    $data['task'] = xarML("Checking format of textbox DD validations");
    ...
    try {
        ...
        //get all properties defined with this proptype format of 2
         $query = "SELECT xar_prop_id, xar_prop_name, xar_prop_source, xar_prop_validation
                    FROM $dynamicprops
                   WHERE xar_prop_type = 2";
