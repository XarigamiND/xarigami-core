...
function main_155()
{
    $data['upgrade']['message'] = xarML('The upgrades for Xarigami Version 1.5.5 were successfully completed');
    ...
    foreach ($upgrades as $upgrade) {
        ...
        $checkfile = str_replace('fix','check',$upgrade);
         ...
         if (!xarUpgrader::loadUpgradeFile('upgrades/xarigami_155/checks/'.$checkfile . '.php')) {
        ...
        if ($checkresult['test'] == 1 && $checkresult['success'] == 1) {
            ...
            if (!xarUpgrader::loadUpgradeFile('upgrades/xarigami_155/updates/' . $upgrade . '.php')) {
