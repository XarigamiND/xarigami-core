...
function fix_120_02()
{
    ...
    $data['success'] = true;
    $data['task'] = xarML("Updating Dynamic Data with Moderate masks ");
    ...
    try {
        ...
        $newmaskarray = array (
            array('ModerateDynamicDataItem','All','dynamicdata','Item','All:All:All','ACCESS_MODERATE',''),
            array('ModerateDynamicData','All','dynamicdata','All','All','ACCESS_MODERATE',''),
            array('ModerateDynamicDataField','All','dynamicdata','Field','All:All:All','ACCESS_MODERATE','')
            );
