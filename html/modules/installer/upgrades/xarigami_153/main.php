...
function main_153()
{
    $data['upgrade']['message'] = xarML('The upgrades for Xarigami Version 1.5.3 were successfully completed');
    ...
    foreach ($upgrades as $upgrade) {
        ...
        if ($checkresult['test'] == 1 && $checkresult['success'] == 1) {
            ...
            if (!xarUpgrader::loadUpgradeFile('upgrades/xarigami_153/updates/' . $upgrade . '.php')) {
