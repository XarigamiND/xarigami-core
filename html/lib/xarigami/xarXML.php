...
/**
 * This subsystem offers an interface to Xarigami to handle XML data
 * It includes:
...
/**
 * Xarigami Generic namespace aware XML parser
 *
 * The Xarigami XML parser. This parser is generic in nature
 ...
 */
class xarXmlParser extends xarObject
{
     ...
     */
    function __construct($encoding=XARXML_CHARSET_DEFAULT,$handler=NULL)
    {
 ...
 */
class xarAbstractXmlHandler extends xarObject
{
    // Abstract functions
